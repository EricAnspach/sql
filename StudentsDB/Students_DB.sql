...
insert into user values (6, 'Frank', 4);
insert into user values (7, 'Gina', 3);
insert into user values (8, 'Harvey', 2);
insert into user values (9, 'Imelda', 1);
insert into user values (10, 'Joe', 3);
insert into user values (11, 'Karen', 4);
insert into user values (12, 'Lou', 2);
insert into user values (13, 'Maria', null);
insert into user values (14, 'Nate', 4);